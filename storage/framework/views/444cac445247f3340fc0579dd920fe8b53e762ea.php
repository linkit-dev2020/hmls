        ...
        <div class="container-wrap">
            <div class="row no-gutters">
                <div class="col-md-3 ftco-animate">
                    <a href="<?php echo e(asset('images/image_1.jpg')); ?>" class="gallery image-popup img d-flex align-items-center" style="background-image: url(<?php echo e(asset('images/course-1.jpg')); ?>);">
                ...
                <div class="col-md-3 ftco-animate">
                    <a href="<?php echo e(asset('images/image_2.jpg')); ?>" class="gallery image-popup img d-flex align-items-center" style="background-image: url(<?php echo e(asset('images/image_2.jpg')); ?>);">
                        <div class="icon mb-4 d-flex align-items-center justify-content-center">
                            <span class="icon-instagram"></span>
                        </div>
                    </a>
                ...
                <div class="col-md-3 ftco-animate">
                    <a href="<?php echo e(asset('images/image_3.jpg')); ?>" class="gallery image-popup img d-flex align-items-center" style="background-image: url(<?php echo e(asset('images/image_3.jpg')); ?>);">
                        <div class="icon mb-4 d-flex align-items-center justify-content-center">
                            <span class="icon-instagram"></span>
                        </div>
                    </a>
                ...
                <div class="col-md-3 ftco-animate">
                    <a href="<?php echo e(asset('images/image_4.jpg')); ?>" class="gallery image-popup img d-flex align-items-center" style="background-image: url(<?php echo e(asset('images/image_4.jpg')); ?>);">
                        <div class="icon mb-4 d-flex align-items-center justify-content-center">
                            <span class="icon-instagram"></span>
                        </div>
                    </a>
...
<?php echo $__env->make('front-end.nhome.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/front-end/nhome/about.blade.php ENDPATH**/ ?>
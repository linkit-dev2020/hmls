    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb"  style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=752&q=80); background-position: 0% center;font-family: Changa;background-size: cover">
        ...
        <div class="row justify-content-end">
            <div class="col-md-6 py-5 px-md-5 ">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" class="ftco-animate" style="text-align: right;direction: rtl;">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->has('username')): ?>
                        <label for=""><?php echo e($errors->first('username')); ?></label><br>
                    <?php endif; ?>
                    <div class="d-md-flex">
                    ...
                    <?php if($errors->has('tc')): ?>
                        <label for=""><?php echo e($errors->first('tc')); ?></label><br>
                    <?php endif; ?>
                    <div class="d-md-flex">
                    ...
                    <?php if($errors->has('password')): ?>
                        <label for=""><?php echo e($errors->first('password')); ?></label><br>
                    <?php endif; ?>
                    <div class="d-md-flex">
                        <div class="form-group ml-md-4">
                    ...
                    <?php if($errors->has('password_confirmation')): ?>
                        <label for=""><?php echo e($errors->first('password_confirmation')); ?></label><br>
                    <?php endif; ?>
                    <div class="d-md-flex">
                        <div class="form-group">
                    ...
                    <?php if($errors->has('phone')): ?>
                        <label for=""><?php echo e($errors->first('phone')); ?></label><br>
                    <?php endif; ?>
                    <div class="d-md-flex">
                        <div class="form-group">
...
<?php echo $__env->make('front-end.nhome.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/auth/register.blade.php ENDPATH**/ ?>
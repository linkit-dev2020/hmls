...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('plugins/OwlCarousel2-2.2.1/owl.theme.default.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('styles/courses.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('styles/courses_responsive.css')); ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="top_bar_content flex-row ">
                                <marquee direction="right" loop="1000"><h3 style="color: #FFFFFF!important;"><?php echo $__env->yieldContent('marq'); ?></h3></marquee>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nav navbar-nav navbar-right nav-social">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(Auth::check()): ?>
                            ...
                            <li class="nav-item">
                                <a class=" nav-link pl-0" href="<?php echo e(route('logout')); ?>" style="font-weight: bolder;font-size: large;color:rgb(158,7,7)!important;"
...
<?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/stdashboard/master.blade.php ENDPATH**/ ?>
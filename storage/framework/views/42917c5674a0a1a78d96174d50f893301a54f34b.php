        ...
        <div class="card color-grey">
          <div class="card-body">
            <div class="card-header">إضافة دينيمي  <i class="fa fa-plus-square" aria-hidden="true"></i></div>
              ...
              <form action="<?php echo e(route('deneme.store')); ?>" enctype="multipart/form-data" method="POST">
                      <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-select mt-3" id="orderField" name="term">
                    ...
                    <option value="1"><?php echo e($terms[0]); ?></option>
                    <option value="2"><?php echo e($terms[1]); ?></option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <a href="<?php echo e(route('deneme.index')); ?>" class="btn btn-default" style="margin-right:5px">إلغاء</a>
              </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/admin/denemes/create.blade.php ENDPATH**/ ?>
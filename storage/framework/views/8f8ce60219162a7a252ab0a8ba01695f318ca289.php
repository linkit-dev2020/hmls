...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('imgs/logo1.png')); ?>" />
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <?php $__currentLoopData = $course->lessons->sortBy('order_num'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $less): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="nav-link" href="/stdsh/showCourse/<?php echo e($course->id); ?>/<?php echo e($less->id); ?>"><h6 class="dropdown-header"><?php echo e($less->title); ?></h6></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    <?php $__currentLoopData = $course->advices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $less): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="/stdsh/showtestcourse/<?php echo e($course->id); ?>/test/<?php echo e($less->id); ?>"><h6 class="dropdown-header"><?php echo e($less->title); ?></h6></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/stdashboard/master3.blade.php ENDPATH**/ ?>
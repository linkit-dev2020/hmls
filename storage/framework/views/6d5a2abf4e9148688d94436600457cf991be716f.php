...
<div id="content">
  <div class="header-card table-cards color-grey">
    <div class="row">
      ...
      <div class="col-lg-2">
        <?php if(!$test->active): ?>
        <form action="<?php echo e(route('test.activate', $test)); ?>" method="POST" id="maketestActivate" style="display:inline; margin-right:10px;">
          <?php echo csrf_field(); ?>
          ...
          <?php else: ?>
          <form action="<?php echo e(route('test.deactivate', $test)); ?>" method="POST" id="maketestDeactivate" style="display:inline; margin-right:10px;">
            <?php echo csrf_field(); ?>
    ...
    <?php if(  $test->type == "video" || $test->type == "audio" ): ?>
            ...
            <div class="card table-cards color-grey">
                <div class="card-body">
                    ...
                    <?php elseif( $advice->type == "audio"): ?>
                        ...
                        <audio controls>
                            <source src= <?php echo $test->src; ?> type="audio/ogg">
                            <source src= <?php echo $test->src; ?> type="audio/mpeg">
            ...
            <tbody>
              <tr>
               ...
               <td><?php echo e($test->term); ?></td>
                  <td><?php echo e($subjects[0]->name); ?></td>
               <td class="go-m"><?php echo e($test->type); ?></td>
               <td><a href="<?php echo e($test->src); ?>">تحميل الدرس</a></td>
              </tr>
            </tbody>
          </table>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-hover table-width">
                        <thead>
                              ...
                              <tbody>
                                <?php $__currentLoopData = $test->attachments()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                        ...
                        <form action="<?php echo e(route('attachment.store')); ?>" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group" >
                                ...
                                <select  class="form-control form-control-select mt-3" id="attachmentable_idField"
                                    ...
                                    <option selected value="<?php echo e($test->id); ?>"><?php echo e($test->title); ?></option>
                                </select>
                            </div>
                            <div class="form-group">
    ...
    <div class="col-lg-6">
      <div class="card table-cards color-grey">
        <div class="card-body">
          ...
          <form action="<?php echo e(route('test.addattachment', $test)); ?>" method="POST"  style="display:inline; margin-right:10px;">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-select mt-3" id="attachment" name="attachment_id">
                    ...
                    <?php $__currentLoopData = $allAttachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aattachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($aattachment->id); ?>"><?php echo e($aattachment->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/admin/tests/show.blade.php ENDPATH**/ ?>
        ...
        <div class="card color-grey">
          <div class="card-body">
            <div class="card-header">إضافة إختبار</div>
              ...
              <form action="<?php echo e(route('test.store')); ?>" enctype="multipart/form-data" method="POST">
                      <?php echo csrf_field(); ?>
           ...
           <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select multiple class="form-control form-control-select mt-3" id="attachmentField" name="attachments">
                    ...
                    <option value="<?php echo e($attachment->id); ?>"><?php echo e($attachment->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                  </select>
                </div> -->
                <div class="radioG">
                ...
                <a href="<?php echo e(route('test.index')); ?>" class="btn btn-default" style="margin-right:5px">إلغاء</a>
              </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\laravel5.8\blog\resources\views/admin/tests/create.blade.php ENDPATH**/ ?>
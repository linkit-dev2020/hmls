...
<table class="table text-dark" style="background: #ddd;color:#555!important;">
    ...
    <tbody>
    <?php $__currentLoopData = $convs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td>
                <?php echo e(\App\User::find($c->sender)->full_name); ?>

            </td>
            <td>
                <?php echo e(\App\Subject::find($c->subject)->name); ?>

            </td>
            <td>
                <a href="/chats/<?php echo e($c->id); ?>/admin">Open</a>
            </td>
        </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\hmls\resources\views/admin/subjects/show.blade.php ENDPATH**/ ?>
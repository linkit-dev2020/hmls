    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown" style="word-break: break-all!important;width:100%;">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown"  style="word-wrap: break-word;">
                @foreach($unit->lessons->sortBy('order_num') as $less)
                    <a  style="  word-break: break-all!important;width:100%;" class="nav-link" href="/stdsh/show/{{$subject->id}}/{{$unit->id}}/{{$less->id}}"><strong class="dropdown-header" style="display:inline!important;">{{$less->title}}</strong></a>
                @endforeach
            </div>
        @endforeach
        </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown"  >
                    @foreach($subject->tests as $less)

                            <a href="/stdsh/showtest/{{$subject->id}}/test/{{$less->id}}"><strong class="dropdown-header" style="  word-wrap: break-word;">{{$less->title}}</strong></a>

...
@section('styles')
	<link rel="stylesheet" type="text/css" href="{{Storage::url('css/course.css')}}">
<link rel="stylesheet" type="text/css" href="{{Storage::url('css/course_responsive.css')}}">
@endsection
<div class="intro">
				...
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							<div class="intro_price">واصفة1</div>
							<div class="rating_r rating_r_4 intro_rating"><i></i><i></i><i></i><i></i><i></i></div>
							<div class="intro_title">اسم الكورس</div>
							<div class="intro_meta">
								<div class="intro_instructors">الصف 1</div>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-lg-9">
										<div class="tabs d-flex flex-row align-items-center justify-content-start">
											<div class="tab active">مقدمة</div>
											<div class="tab">الوحدات الدراسية</div>
											<div class="tab">المدرسين</div>
											<div class="tab">الزملاء</div>
										</div>
									</div>
								</div>
							</div>		
